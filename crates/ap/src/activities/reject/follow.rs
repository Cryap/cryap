...
use activitypub_federation::{
    ...
    kinds::activity::{FollowType, RejectType},
...
use crate::{
    activities::{follow::Follow, generate_reject_activity_id, is_duplicate},
    objects::user::ApUser,
};
...
impl RejectFollow {
    pub async fn send(
        ...
        let id = generate_reject_activity_id(&actor.ap_id, FollowType::Follow)?;
